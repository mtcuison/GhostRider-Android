package org.rmj.guanzongroup.ghostrider.PetManager.Dialog;
...
import org.rmj.guanzongroup.ghostrider.PetManager.Adapter.BranchSelectionAdapter;
...
public class DialogBranchSelection {
    ...
    private BranchSelectionAdapter loAdapter;
    ...
    public void initDialog(boolean isCancelable, OnBranchSelectedCallback foCallback){
        ...
        loAdapter = new BranchSelectionAdapter(area, (BranchCode, BranchName) -> {
            try{
        ...
        rgBranch.setOnCheckedChangeListener((group, checkedId) -> {
            if(checkedId == R.id.rb_area){
                ...
                loAdapter = new BranchSelectionAdapter(all, (BranchCode, BranchName) -> {
                    try{
                        poMessage.initDialog();
                        poMessage.setTitle("Branch Selected");
                        poMessage.setMessage("You selected " + BranchName + ". Continue Selfie log?");
