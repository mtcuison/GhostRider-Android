package org.rmj.guanzongroup.ghostrider.PetManager.Adapter;
...
public class BranchSelectionAdapter extends RecyclerView.Adapter<BranchSelectionAdapter.BranchListViewHolder> {
    ...
    public BranchSelectionAdapter(List<EBranchInfo> paBranch, OnBranchSelectListener listener) {
    ...
    public class BranchFilter extends Filter{
        ...
        private final BranchSelectionAdapter poAdapter;

        public BranchFilter(BranchSelectionAdapter poAdapter) {
            super();
