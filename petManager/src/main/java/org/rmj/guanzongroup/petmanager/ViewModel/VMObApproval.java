        ...
        TaskExecutor.Execute(callback, new OnTaskExecuteListener() {
            ...
            public Object DoInBackground(Object args) {
                ...
                try{
                    ...
                    if(!poSys.DownloadApplication(TransNox)){
            ...
            public void OnPostExecute(Object object) {
                Boolean lsSucceess = (Boolean) object;
                if(lsSucceess){
...
//        new ConfirmApplicationTask(callback).execute(infoModel);
        TaskExecutor.Execute(callback, new OnTaskExecuteListener() {
            ...
            @Override
            public Object DoInBackground(Object args) {
                OBApprovalInfo lsOBApprovalInfo = (OBApprovalInfo) args;
                try{
                    if(!poConn.isDeviceConnected()) {
...
//
//    private final VMObApproval.OnConfirmApplicationCallback callback;
//
//    private String message;
//
//    public ConfirmApplicationTask(VMObApproval.OnConfirmApplicationCallback callback){
