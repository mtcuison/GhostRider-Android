...
public class VMEvaluationHistoryInfo extends AndroidViewModel {
    ...
    private static class CustomerEvaluationInfoTask extends AsyncTask<ECIEvaluation, Void, List<EvaluationHistoryInfoModel>> {
        private final Application instance;
        private final OnFetchCustomerEvaluationInfo pmListener;

        public CustomerEvaluationInfoTask(Application fsInstance, OnFetchCustomerEvaluationInfo fmListener) {
