...
public class EventNotification implements iNotificationUI {
    ...
    public static final String NotificationID = "org.rmj.guanconnect.guanzonevent";
    private static final String CHANNEL_NAME = "Guanzon Events";
    private static final String CHANNEL_DESC = "Guanzon connect rewards notification for panalo participants.";

    public EventNotification(Context mContext, ENotificationMaster message) {
