...
public class Properties {
    ...
    private String ps4Wheelsx = "0";
    private String ps3Wheelsx = "0";
    private String ps2Wheelsx = "0";
    private String psAirConxx = "0";
    private String psFridgexx = "0";
    private String psTelevsnx = "0";
