...
public class VMDependentTest implements ViewModelCallBack, VMDependent.ExpActionListener {
    ...
    public void test_getInfoModels(){
        addDependent();
        for (int i = 0; i< mViewModel.getAllDependent().getValue().size(); i++){
            ...
            System.out.print("Dependent is Employed Y(1)/N(0)? = " + infoModel.getDpdEmployedSector() + "\n");
