...
public class Activity_ResidenceInfo extends AppCompatActivity {
    ...
    private void SaveResidenceInfo() {
        ...
        mViewModel.getModel().setProvinceNm(txtProvince.getText().toString());
        mViewModel.getModel().setMunicipalNm(txtMunicipality.getText().toString());
        mViewModel.getModel().setBarangayName(txtBarangay.getText().toString());
        mViewModel.getModel().setOwnerRelation(Objects.requireNonNull(txtRelationship.getText()).toString());
        mViewModel.getModel().setLenghtOfStay(Double.parseDouble(Objects.requireNonNull(txtLgnthStay.getText()).toString()));
