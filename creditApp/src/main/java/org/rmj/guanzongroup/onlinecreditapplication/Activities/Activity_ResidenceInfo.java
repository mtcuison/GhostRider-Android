...
public class Activity_ResidenceInfo extends AppCompatActivity implements ViewModelCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnHouseHold.setOnItemClickListener(new Activity_ResidenceInfo.OnItemClickListener(spnHouseHold));
        spnHouseType.setOnItemClickListener(new Activity_ResidenceInfo.OnItemClickListener(spnHouseType));
        spnLgnthStay.setOnItemClickListener(new Activity_ResidenceInfo.OnItemClickListener(spnLgnthStay));
    ...
    private void initWidgets() {
        ...
        cbOneAddress.setOnCheckedChangeListener(new Activity_ResidenceInfo.OnAddressSetListener());
        rgOwnsership.setOnCheckedChangeListener(new Activity_ResidenceInfo.OnHouseOwnershipSelectListener());
        rgGarage.setOnCheckedChangeListener(new Activity_ResidenceInfo.OnHouseOwnershipSelectListener());
