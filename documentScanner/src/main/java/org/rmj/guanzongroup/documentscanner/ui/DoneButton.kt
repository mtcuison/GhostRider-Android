package org.rmj.guanzongroup.documentscanner.ui
...
import org.rmj.guanzongroup.documentscanner.R
import org.rmj.guanzongroup.documentscanner.extensions.drawCheck

/**
 * This class creates a circular done button by modifying an image button. The user presses this
 * button once they finish cropping an image
 *
 * @param context image button context
 * @param attrs image button attributes
 * @constructor creates done button
 */
class DoneButton(context: Context, attrs: AttributeSet) : AppCompatImageButton(context, attrs) {
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    val innerRadius = outerRadius - resources.getDimension(R.dimen.large_button_outer_ring_offset)
