...
public class SelfieLog {
    ...
    public void setImageInfo(EImageInfo foImgInfo) {
        ...
        poImage.insertImageInfo(poImgInfo);
    }
    ...
    public void SaveTransaction(OnActionCallback callback){
        try {
            if(poImgInfo == null){
...
//                        }
//                    } else {
//                        callback.OnFailed("Unable to upload selfie. Server no response.");
//                    }
//                }
...
//                Thread.sleep(1000);
    ...
    public void RequestInventoryStocks(OnActionCallback callback){
        try {
