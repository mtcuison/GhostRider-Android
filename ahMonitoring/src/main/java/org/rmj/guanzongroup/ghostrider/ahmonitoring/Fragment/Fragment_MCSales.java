...
public class Fragment_MCSales extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_mc_sales, container, false);
...
//            desc.setTextSize(28);
//            desc.setTextColor(getResources().getColor(R.color.guanzon_deep_dark_grey));

            for (int x = 0; x< eperformance.size(); x++){
                values1.add(new Entry(x, eperformance.get(x).getMCActual()));
            }
