 ...
 * project file created : 5/6/21 9:01 AM
...
public class NewsEventSpacing  extends RecyclerView.ItemDecoration {
    private int spanCount; //Number of columns
    private int spacing; //interval
    private boolean includeEdge; //Whether to include edges

    public NewsEventSpacing(int spanCount, int spacing, boolean includeEdge) {
