...
public class Fragment_DeptHeadHome extends Fragment {

    private VMDeptHead mViewModel;

    public static Fragment_DeptHeadHome newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dept_head_home, container, false);
    }
}