...
public class EvaluationManager {
    private static final String TAG = EvaluationManager.class.getSimpleName();
    ...
    public EvaluationManager(Application application) {
    ...
    public void DownloadCreditApplications(OnActionCallback callback){
        try{
            ...
            String lsResponse = WebClient.sendRequest(WebApi.URL_DOWNLOAD_CI_APPLICATION, params.toString(), poHeaders.getHeaders());
            if(lsResponse == null){
